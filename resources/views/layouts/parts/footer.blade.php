  ...
  <div class="footer-container">
    <div class="column1">
      <div class="header-logo">
        <a href="index.html">
          <img class="logo-hd"  src="{{ asset('assets/front/images/logo60-removebg.png') }}" alt="logo">
          <img class="logo-sm" src="{{ asset('assets/front/images/logo6060-2-removebg.png') }}" alt="logo">
        </a>
      </div>
      <div class="bottom-text">
        <p>ООО «СиМедКомпани»</p>
        <p>г.Речица, ул. Строителей 2а, каб.47</p>
        <p>УНП: 100394906</p>
        <p>Электронная почта: <a href="mailto:info@simed.by">info@simed.by</a></p>
      </div>

      <p class="p-legal"><a href="{{  route('privacy-policy') }}">Политика конфиденциальности</a></p>
	  <p class="p-documents"><a href="{{  route('documents') }}">Документы</a></p>
    </div>

    <div class="column2">
      <nav id="bottom-menu-nav">
          <ul id="bottom-menu" class="nav"><li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-21"><a href="{{ route('about') }}">О клинике</a></li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-has-children menu-item-42"><a href="{{  route('services') }}">Услуги</a>
<ul class="sub-menu">
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-46"><a href="index.html@p=29.html">Имплантация</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-117"><a href="index.html@p=115.html">Протезирование</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-44"><a href="index.html@p=35.html">Лечение под микроскопом</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-120"><a href="index.html@p=118.html">Исправление прикуса</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-43"><a href="index.html@p=38.html">Рентген-диагностика</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-123"><a href="index.html@p=121.html">Отбеливание зубов</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-45"><a href="index.html@p=32.html">SPA-уход для зубов</a></li>
	<li class="menu-item-object-custom menu-item menu-item-type-custom menu-item-112"><a href="index.html#">test</a></li>
	<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-126"><a href="index.html@p=124.html">Стоматология по страховке</a></li>
</ul>
</li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-52"><a href="{{ route('doctors') }}">Специалисты</a></li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-411"><a href="{{ route('prices') }}">Цены</a></li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-139"><a href="{{ route('reviews') }}">Отзывы</a></li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-544"><a href="{{ route('patients') }}">Пациентам</a></li>
<li class="menu-item-object-page menu-item menu-item-type-post_type menu-item-130"><a href="{{  route('contacts') }}">Контакты</a></li>
</ul>      </nav>
    </div>
    ...
    <div class="column3">
      ...
      <p class="footer-adr">г.Речица, ул. Строителей 2а, каб.47</p>
  ...
  <div class="footer-row">
    ...
    <div class="footer-email">
      <a href="mailto:info@simed.by" class="email-svg">
    ...
    <div class="footer-whatsapp">
      <a href="tel:+375291030104" class="whatsapp-svg">
      ...
      <div id="customNotification" class="popup">
        <div class="popup-content">
          ...
          <div class="popup-message">
            <h6>Напоминаем</h6>
            <p>
              Запись на приём ведется по номеру<br />
              телефона <a href="tel:+375447229911">+375 (44) 722-99-11</a>.<br />
              Запись на приём через страницу в Instagram<br />
              не осуществляется.
            </p>
          </div>
        </div>
