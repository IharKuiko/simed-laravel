...
@section('title', 'Редактировать категорию гинекологии')
...
@section('content')
    ...
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Редактировать категорию гинекологии</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="float-sm-end breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.main.index') }}">Админ панель</a></li>

                        <li class="breadcrumb-item"><a href="{{ route('ginecology-service-categories.index') }}">Категории гинекологии</a></li>
                        <li class="breadcrumb-item active" aria-current="page">
                            Редактировать категорию гинекологии
                        </li>
                    </ol>
                </div>
            </div> <!--end::Row-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-4 card-outline card card-warning"> <!--begin::Header-->
                        <div class="card-header">
                            <div class="card-title">Редактировать категорию: <strong>{{ $category->title }}</strong></div>
                        </div> <!--end::Header-->

                        <form action="{{ route('ginecology-service-categories.update', ['ginecology_service_category' => $category->id]) }}" method="post">
                            @csrf
                            @method('PUT')
