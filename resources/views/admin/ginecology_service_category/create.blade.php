...
@section('title', 'Новая категория услуг')
...
@section('content')
    ...
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Новая категория</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="float-sm-end breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.main.index') }}">Админ панель</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('service-categories.index') }}">Категории гинекологии</a></li>
            ...
            <div class="row"> <!--begin::Col-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-4 card-outline card card-warning"> <!--begin::Header-->
                        ...
                        <form action="{{ route('ginecology-service-categories.store') }}" method="post">
                            @csrf
