...
@section('title', 'Редактирование услуги УЗИ')
...
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Редактирование услуги УЗИ</h3>
                </div>
                <div class="col-sm-6">
    ...
    <div class="app-content"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            ...
            <form method="post" action="{{ route('ultrasound-services.update', ['ultrasound_service' => $service->id]) }}">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        <option value="active" {{ $service->status == 'active' ? 'selected' : '' }}>Активна</option>
