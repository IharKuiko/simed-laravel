...
@section('content')
<div class="service-detail-container ultrasound-service">
    <!-- Хлебные крошки для навигации -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/">Главная</a></li>
            <li class="breadcrumb-item"><a href="/services">Услуги</a></li>
            <li class="breadcrumb-item"><a href="/ultrasound">УЗИ</a></li>
                    ...
                    <div class="service-image-placeholder">
                        <div class="text-center">
                            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 2L2 7V12C2 16.5 4.23 20.68 7.62 23.15L12 24L16.38 23.15C19.77 20.68 22 16.5 22 12V7L12 2Z" fill="#a7c7d9" fill-opacity="0.2"/>
                                <path d="M9 12L11 14L15 10" stroke="#a7c7d9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                ...
                <div class="service-details">
                    ...
                    <div class="service-unit">
                        <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 11H15M21 11C21 16.5228 16.5228 21 11 21C5.47715 21 1 16.5228 1 11C1 5.47715 5.47715 1 11 1C16.5228 1 21 5.47715 21 11Z" stroke="#a7c7d9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Тип: {{ $service->unit }}
                    </div>
                    @endif
                    ...
                    <div class="service-duration">
                        <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12" cy="12" r="10" stroke="#a7c7d9" stroke-width="2"/>
                            <path d="M12 6V12L16 14" stroke="#a7c7d9" stroke-width="2" stroke-linecap="round"/>
                        </svg>
    ...
    @if($service->category_id && $relatedServices = \App\Models\UltrasoundService::where('category_id', $service->category_id)
            ->where('id', '!=', $service->id)
            ->where('status', 'active')
            ->take(3)
            ->get())
        ...
        <div class="related-services-grid">
            @foreach($relatedServices as $relatedService)
                <div class="related-service-card">
                    ...
                    <a href="{{ route('ultrasound_service_details', $relatedService->slug) }}" class="btn-outline-primary">Подробнее</a>
                </div>
            @endforeach
        </div>
    </section>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bookingForm">
                    ...
                    <input type="hidden" id="serviceType" value="ultrasound" />
